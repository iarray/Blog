 ...
 public class Startup
    {  
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var authenticationProviderKey = "Sesame";
            Action<IdentityServerAuthenticationOptions> options = o =>
            {
                o.Authority = authority ?? "http://127.0.0.1:5000";
                o.ApiName = Configuration.GetValue<string>("IdentityServer.ApiName") ?? "apis";
                o.RequireHttpsMetadata = false;
                o.SupportedTokens = SupportedTokens.Both;
                o.ApiSecret = "Sesame_ApiGateway";
            };
            ...
            //    o.Authority = authority ?? "http://127.0.0.1:5000";
            //    o.RequireHttpsMetadata = false;
            //    o.Audience = Configuration.GetValue<string>("IdentityServer.ApiName") ?? "apis";               
            //});
